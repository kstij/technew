...
function createClient(params) {
    ...
    const userAgentHeader = (0,contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__.getUserAgentHeader)(`contentful.js/${"10.11.3"}`, config.application, config.integration);
