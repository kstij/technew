...
export default function Button1({ children, href }) {
  return (
    <a
      href={href}
      className="button1 text-white rounded-lg font-semibold border-white border-2 hover:bg-gray-800 group sm:px-5 sm:py-3 px-3 py-2 flex items-center gap-x-1 flex-shrink-0 transition-all duration-200 text-base xl:text-h6 2xl:text-h5"
